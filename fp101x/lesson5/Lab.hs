...
{- First we need to find the digits of a number. Define a function
   ...
   that takes a n :: Integer  where n >= 0 and returns a list of the digits of n. More precisely, toDigits should satisfy
   the following properties, for all n :: Integer  where n >= 0:
...
{- Now we need to reverse the digits of a number. Define a function
   ...
   that takes a n :: Integer  where n >= 0 and returns a list of the digits of n in reverse order. More precisely,
   toDigitsRev should satisfy the following properties, for all n :: Integer  where n >= 0::
